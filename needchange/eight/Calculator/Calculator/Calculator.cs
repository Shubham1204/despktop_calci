...
namespace Calculator
{
    public partial class Calculator : Form
    {
        ...
        public Calculator()
        {
            ...
            this.mcBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.mrBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.msBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.mPlusBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.plusMinusBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.rootBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.divBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.modBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.mulBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.oneDivXBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.minusBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.dotBtn.Click += new System.EventHandler(this.numberBtnClick);
            ...
            this.plusBtn.Click += new System.EventHandler(this.operatorClicked);
            ...
            this.equalBtn.Click += new System.EventHandler(this.operatorClicked);
        ...
        private void numberBtnClick(object sender, EventArgs e)
        {
            ...
            if (input == ".")
            {
                ...
                if (!inputTxtbox.Text.Contains('.') && !inputTxtbox.Text.Contains('E'))
                {
                    //add decimal point to label
                    inputTxtbox.Text += '.';
                    label1.Text += '.';
                }
                else if (inputTxtbox.Text.Contains('.'))
                {
                    //Display error message
                    label1.Text = "Cannot add another decimal";
                    clearerror = true;
                }
                else if (inputTxtbox.Text.Contains('E'))
                {
                    //Display error message
                    label1.Text = "Cannot add a decimal to E";
                    clearerror = true;
                }
        ...
        //{
          //  if (label1.Text != null && !isText)
            //{
              ...
              //  label1.Text = (memory + double.Parse(label1.Text)).ToString();
 //           }
   //         else
     //       {
                //Display error message
       //         label1.Text = "Cannot add an invalid value to Memory";
         //   }
        //}
        ...
        public void Equals_Click(object sender, EventArgs e)
        {
            ...
            if (inputTxtbox.Text != null && !isText)
            {
                ...
                y = double.Parse(inputTxtbox.Text);
        ...
        public void plusMinus()
        {
            ...
            if (inputTxtbox.Text != null && !isText)
            {
                ...
                y = double.Parse(inputTxtbox.Text) * -1;
                inputTxtbox.Text = y.ToString();
        ...
        private void addOperand(string input)
        {
            ...
            if (inputTxtbox.Text != null && !isText)
            {
                ...
                x = double.Parse(inputTxtbox.Text);
                //Set to clear text on next input
                cleartext = true;

                //Display operation
                label1.Text = $"{x} {operand} ";
                clearerror = false;
            }
            else
            {
